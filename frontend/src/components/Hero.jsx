...
const Hero = () => {
  return (
    <section id="hero" className="relative">
      ...
      <div className="relative min-h-screen flex flex-col justify-center items-center text-center max-sm:mx-2 sm:mx-10 md:mx-20 lg:mx-80 ">
        ...
        <div className="flex flex-row  flex-wrap justify-center items-center gap-5 sm:gap-14 md:gap-20 lg:gap-32 pt-10 md:pt-20">
